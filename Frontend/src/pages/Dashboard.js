...
function Dashboard() {
  ...
  const fetchTotalSaleAmount = () => {
    fetch(
      `https://ims-api-beige.vercel.app/api/sales/get/${authContext.user}/totalsaleamount`
    )
  ...
  const fetchTotalPurchaseAmount = () => {
    fetch(
      `https://ims-api-beige.vercel.app/api/purchase/get/${authContext.user}/totalpurchaseamount`
    )
      .then((response) => response.json())
  ...
  const fetchMonthlySalesData = () => {
    fetch(`https://ims-api-beige.vercel.app/api/sales/getmonthly`)
      .then((response) => response.json())
